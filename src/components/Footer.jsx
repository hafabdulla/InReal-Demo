...
// A link with `to` is an internal route and renders as a router <Link>, so it
// navigates without a full page reload. `href` stays a plain anchor for
// on-page jumps and mailto:.
//
// The remaining `#` entries are pre-existing placeholders for documents that do
// not exist yet. Privacy Policy is the one that matters: the Terms now live at
// /terms incorporate a Privacy Policy by reference (section 3.1(c)) and cite
// DIFC Law No. 5 of 2020, and that document has still not been supplied. Left
// dead rather than pointed at something invented.
const FOOTER_LINKS = {
