/**
 * InReal Backend API Server (PostgreSQL)
 * Option 2: Hosted backend + hosted DB for quick live demo.
 */
...
if (!process.env.DATABASE_URL) {
  console.error(
    'Missing DATABASE_URL. Create a Supabase project and set DATABASE_URL to the Postgres connection string before starting server.postgres.js.'
  );
  process.exit(1);
}
